...
TaxRates.init({
    id: {
        ...
        type: DataTypes.STRING, allowNull: true, columnName: 'description',
    }, rate: {
        type: DataTypes.DECIMAL, allowNull: false, columnName: 'rate',
    }, countryCode: {
        type: DataTypes.STRING, allowNull: false, columnName: 'country_code',
    }, taxType: {
        type: DataTypes.ENUM(['direct_tax']), allowNull: false, columnName: 'tax_type',
    },
    status: {
...
TaxRates.belongsTo(User, {
    foreignKey: {
        allowNull: false, columnName: "created_by", name: "createdBy"
    }, as: "createdByUser"
})
TaxRates.belongsTo(OrganizationBasic, {
    foreignKey: {
        allowNull: false, columnName: "organization_id", name: "organizationId"
    }, as: "organization"
})
